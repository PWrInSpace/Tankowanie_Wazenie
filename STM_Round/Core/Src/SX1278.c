...
void SX1278_config(SX1278_t *module, uint64_t frequency, uint8_t power,
	...
	SX1278_SPIBurstWrite(module, LR_RegFrMsb, (uint8_t*) Frequency_to_device,
			3); //setting  frequency parameter
...
int SX1278_LoRaTxPacket(SX1278_t *module, uint8_t *txBuffer, uint16_t length,
		uint32_t timeout) {
...
int SX1278_receive(SX1278_t *module, uint16_t length, uint32_t timeout) {
