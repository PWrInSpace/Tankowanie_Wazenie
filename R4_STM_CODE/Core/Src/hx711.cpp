...
double HX711::getBitsToGramRatio() const{
...
void HX711::initialCalibration(double testLoadInGrams, uint16_t calibrationTime){
	...
	BitsToGramRatio = (double)(weightWithLoad - initialWeight) / testLoadInGrams;
}
